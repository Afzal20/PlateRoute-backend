...
# Media files / Google Drive Storage Configuration
if os.environ.get("USE_GOOGLE_DRIVE_STORAGE", "false").lower() == "true":
    ...
    GOOGLE_DRIVE_STORAGE_MEDIA_ROOT = "plateroute_media"
else:
    MEDIA_URL = "media/"
